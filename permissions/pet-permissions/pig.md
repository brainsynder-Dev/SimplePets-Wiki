...
| pet.type.pig.data.half_scale<br><mark style="color:orange;"><code>(Added in R5-B294)</code></mark> | Will allow the player to view/toggle the 'Half Scale' Data Item |
...
| pet.type.pig.data.variant | Will allow the player to view/toggle the 'Variant' Data Item |
