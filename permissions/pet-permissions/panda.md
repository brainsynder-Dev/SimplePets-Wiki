...
| pet.type.panda.data.half_scale<br><mark style="color:orange;"><code>(Added in R5-B294)</code></mark> | Will allow the player to view/toggle the 'Half Scale' Data Item |
...
| pet.type.panda.data.eating | Will allow the player to view/toggle the 'Eating' Data Item |
| pet.type.panda.data.sleep | Will allow the player to view/toggle the 'Sleep' Data Item |
