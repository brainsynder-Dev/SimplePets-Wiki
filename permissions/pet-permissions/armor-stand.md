...
| pet.type.armorstand.*<br><mark style="color:orange;"><code>(Added in v5.0-BUILD-1000)</code></mark> | Grants full access to the pet, such as spawning the pet, flying, mounting, hat, and all the data items |
...
| pet.type.armorstand.data.*<br><mark style="color:orange;"><code>(Added in v5.0-BUILD-1000)</code></mark> | Grants full access to all the data toggles for modifying the pet (<mark style="color:red;">/pet data armor_stand</mark>) |
